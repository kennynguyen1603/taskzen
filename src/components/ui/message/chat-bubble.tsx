...
const ChatBubble = React.forwardRef<HTMLDivElement, ChatBubbleProps>(
  ({ className, variant, layout, children, senderId, loggedInUserId, ...props }, ref) => {
    // Xác định variant dựa trên việc so sánh senderId và loggedInUserId
    const bubbleVariant = senderId === loggedInUserId ? 'sent' : 'received'

    return (
      <div
        className={cn(chatBubbleVariant({ variant: bubbleVariant, layout, className }), 'relative group')}
        ref={ref}
        {...props}
      >
